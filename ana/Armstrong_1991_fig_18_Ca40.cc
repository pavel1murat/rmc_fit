...
#include "TAxis.h"
//-----------------------------------------------------------------------------
int rmc_data::GetArmstrong_1991_fig_18_Ca40(Data_t* Data) {
  ...
  double data [] = {
    56.5, 102., 57.5, 109., 58.5,  97., 59.5,  88., 60.5, 109.,
    61.5, 114., 62.5, 133., 63.5,  88., 64.5,  98., 65.5,  87.,
    66.5,  89., 67.5,  81., 68.5,  74., 69.5,  92., 70.5,  81.,
    71.5,  76., 72.5,  72., 73.5,  79., 74.5,  52., 75.5,  62.,
    76.5,  43., 77.5,  49., 78.5,  33., 79.5,  28., 80.5,  29.,
    81.5,  32., 82.5,  18., 83.5,  23., 84.5,  17., 85.5,  18.,
    86.5,  23., 87.5,   6., 88.5,  10., 89.5,   6., 90.5,   4.,
    91.5,   2., 92.5,   4., 93.5,   6., 94.5,   5., 95.5,   3.,
    96.5,   3., 97.5,   0., 98.5,   0., 99.5,   4.,
    -1 };

  if (Data->fHist) delete Data->fHist;
  Data->fHist = new TH1F("h_Armstrong_1991_fig_18_Ca40","",nbins,xmin,xmax);
  ...
  Data->fHist->SetTitle("Phys Rev C v43  p1425 (1991), figure 18, Ca40");
